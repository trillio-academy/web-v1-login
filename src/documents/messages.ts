...
export const documentMessages = {
  pt: {
    ...
    validacao: {
      ...
      validSubtitle: 'Este certificado foi validado com sucesso.',
      ...
      close: 'Fechar',
      certificateOf: 'Certificado de',
      referenteAoCurso: 'referente ao curso',
      concluidoEm: 'concluído em',
      validarOutro: 'Validar outro',
    ...
    login: {
      ...
      loginLabel: 'Login (Email/CPF/Login de usuário)',
      ...
      ssoButton: 'Entrar com SSO',
      ssoOnlyHint: 'Use o login corporativo da sua empresa para acessar a plataforma.',
  ...
  en: {
    ...
    validacao: {
      ...
      validSubtitle: 'This certificate has been successfully validated.',
      ...
      referenteAoCurso: 'for the course',
      concluidoEm: 'completed on',
      validarOutro: 'Validate another',
    ...
    login: {
      ...
      play: 'Trillio Play',
      business: 'Trillio Business',
      loginLabel: 'Login (Email/CPF/User login)',
      ...
      ssoOnlyHint: 'Use your company corporate login to access the platform.',
  ...
  es: {
    ...
    validacao: {
      ...
      checking: 'Verificando...',
      valid: 'Certificado válido.',
      validSubtitle: 'Este certificado ha sido validado correctamente.',
      ...
      close: 'Cerrar',
      certificateOf: 'Certificado de',
      referenteAoCurso: 'referente al curso',
      concluidoEm: 'completado el',
      validarOutro: 'Validar otro',
    ...
    login: {
      ...
      play: 'Trillio Play',
      business: 'Trillio Business',
      loginLabel: 'Login (Email/CPF/Usuario)',
      ...
      ssoOnlyHint: 'Use el inicio de sesión corporativo de su empresa para acceder a la plataforma.',
